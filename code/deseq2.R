...
directory <- "D:/yx749/Downloads/genome_analysis/analyses/05_rna_mapping/03_htseq"
...
heatmap.2(assay(rld)[topPadjGenes,], scale="row", trace="none", dendrogram="row", 
...
heatmap.2(assay(rld)[topLfcGenes,], scale="row", trace="none", dendrogram="row", 
